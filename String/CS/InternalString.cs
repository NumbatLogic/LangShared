namespace NumbatLogic
{
	class InternalString
	{
		...
		public InternalString(string sxString)
		{
			Set(sxString);
		}
		...
		public void Set(string sxString)
		{
			m_pStringBuilder = new System.Text.StringBuilder(sxString);
		}
		...
		public void AppendString(string sxString)
		{
			m_pStringBuilder.Append(sxString);
		}
		...
		public bool StartsWith(string sxString)
		{
			return m_pStringBuilder.ToString().StartsWith(sxString);
		}

		public bool EndsWith(string sxString)
		{
			return m_pStringBuilder.ToString().EndsWith(sxString);
		}
